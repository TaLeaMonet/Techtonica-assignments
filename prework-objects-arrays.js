...
animals.push("lizard", "turtle", "snake", "toad");
...
function hello(numArray) {
  for (i = 0; i <= numArray.length - 1; i++) {
    var currentNumber = numArray[i];
    if (currentNumber > 100) {
      console.log(numArray[i] + " is BIG");
    } else if (currentNumber >= 0 && currentNumber <= 100) {
      console.log(numArray[i] + " is small");
    } else if (currentNumber < 0) {
      console.log(numArray[i] + " is negative");
    }
  }
}
