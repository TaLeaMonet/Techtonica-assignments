...
// num2 but not num1?
// In the first example, num1 will return a number between 2 and 9 since min is subtracted from max, but included as a possible return. The second example includes +1 in the return, so it includes the two given values.
...
var myAnswerForExercise10 = "a string";

// Exercise 11. What is the data type of the value stored in 'product',
// place your answer in the quotes below:

var myAnswerForExercise11 = "a number";
...
var C = 4;
var D = "D";
var myAnswerForExercise14 = A + "n" + D;
...
var C = 4;
var D = "D";
var myAnswerForExercise15 = A + B * 2 + D + C / 2;

console.log(
  myAnswerForExercise15 + ", the most awesome droid in a galaxy far away!"
);
...
var myAnswerForExercise17 = true || false;

console.log(myAnswerForExercise17);
//Returns true.

// Exercise 18 What is the value of 1 === "1"
var myAnswerForExercise18 = 1 === "1";

console.log(myAnswerForExercise18);
//Returns false, because a number is not the same as a string.

// Exercise 19 What is the value of 1 == "1"

var myAnswerForExercise19 = 1 == "1";

console.log(myAnswerForExercise19);
//Returns true, because 1 is equal to the number in the string.

// Exercise 20 What is the value of 1 < 1
var myAnswerForExercise20 = 1 < 1;
...
var myAnswerForExercise21 = 1 < 2 < 3;
...
var myAnswerForExercise22 = 2 < 1 < 3;
...
//Exercise 5 was somewhat challenging. Some references that I found helpful were MDN and W3Schools.
